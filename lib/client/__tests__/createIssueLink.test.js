...
const fixture = require('./fixtures/createIssueLink.json');

test('createIssueLink', async t => {
  ...
  const response = await client.createIssueLink({ ...fixture.body });
  ...
  t.deepEqual(response, { ...fixture.body });
});
